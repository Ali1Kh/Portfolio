...
export default function ProjectDetails() {
  ...
  const { id } = useParams();
  let { data, isLoading } = useQuery("projectDetails", getProjectDetails , { cacheTime: 0});
          ...
          <>
            <header className="banner p-5 borderBottomGrey mb-2">
              ...
              >
                <div className="title text-center">
                  <h1 style={{ fontSize: "55px" }}>{projectDetails.name}</h1>
                </div>
              ...
              <div className="projInfo  d-flex flex-column align-items-center">
                ...
                {projectDetails.technologies.map((tech)=>    <div className="techItem d-flex gap-2 align-items-center borderGrey rounded-5 px-2 py-1">
            ...
            <div className="projScreens">
              ...
              >
                ...
                {projectDetails.images.map((image)=><a
                  className="imageItem"
